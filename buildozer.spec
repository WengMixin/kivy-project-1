...
# requirements = python3==3.7.6,hostpython3==3.7.6,kivy,pillow,jnius,pyusb,requests,numpy==1.21.0,logging
requirements = python3==3.7.6,hostpython3==3.7.6,kivy,pillow,jnius,pyusb,requests,pyjnius
...
# android.permissions = android.permission.INTERNET, (name=android.permission.WRITE_EXTERNAL_STORAGE;maxSdkVersion=18), ACCESS_NETWORK_STATE, WRITE_EXTERNAL_STORAGE
android.permissions = android.permission.INTERNET, ACCESS_NETWORK_STATE, WRITE_EXTERNAL_STORAGE
